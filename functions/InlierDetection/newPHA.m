...
% 
subindd = (slope2 > sind(PARAM.phaseLR)^2 & xdiff > 0 & slope2 < sind(PARAM.phaseLRC)^2) | ...
    (slope2 < sind(PARAM.phaseLRC1)^2 & xdiff > 0 & dist2 < PARAM.distt^2 & slope2 > sind(PARAM.phaseLR1)^2);


subind = subind & dist2>PARAM.nearFF;
subindd = subindd & dist2>PARAM.nearFF;
